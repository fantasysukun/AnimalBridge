...
public class HelloWorldService {
    ...
    public static Response GetAllUser() {
        ...
        try {
            ...
            String Error = "RESTful layer GetAllUser method has error!!!";
            OutputJSON = gson.toJson(Error);
        }
        return Response.status(200).entity(OutputJSON).build();
    }
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public static Response GetAllAnimal() {
        Gson gson = new Gson();
        String OutputJSON = gson.toJson("");
        try {
            HashMap<Integer, animalbridge_animals> Testing = Model.animalbridge_animals();
            OutputJSON = gson.toJson(Testing);
        } catch (Exception e) {
            String Error = "RESTful layer GetAllAnimals method has error!!!";
            OutputJSON = gson.toJson(Error);
        }
        return Response.status(200).entity(OutputJSON).build();
    }
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public static Response GetAllEmergencyContact() {
        Gson gson = new Gson();
        String OutputJSON = gson.toJson("");
        try {
            HashMap<Integer, animalbridge_emergencycontact> Testing = Model.animalbridge_emergencycontact();
            OutputJSON = gson.toJson(Testing);
        } catch (Exception e) {
            String Error = "RESTful layer GetAllEmergencyContact method has error!!!";
            OutputJSON = gson.toJson(Error);
        }
        return Response.status(200).entity(OutputJSON).build();
    }
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public static Response GetAllAboutUs() {
        Gson gson = new Gson();
        String OutputJSON = gson.toJson("");
        try {
            HashMap<Integer, animalbridge_aboutus> Testing = Model.animalbridge_aboutus();
            OutputJSON = gson.toJson(Testing);
        } catch (Exception e) {
            String Error = "RESTful layer GetAllAboutUs method has error!!!";
            OutputJSON = gson.toJson(Error);
        }
        return Response.status(200).entity(OutputJSON).build();
    }
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public static Response GetAllContactUs() {
        Gson gson = new Gson();
        String OutputJSON = gson.toJson("");
        try {
            HashMap<Integer, animalbridge_contactus> Testing = Model.animalbridge_contactus();
            OutputJSON = gson.toJson(Testing);
        } catch (Exception e) {
            String Error = "RESTful layer GetAllContactUs method has error!!!";
            OutputJSON = gson.toJson(Error);
        }
        return Response.status(200).entity(OutputJSON).build();
    }
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public static Response GetAllHomepage() {
        Gson gson = new Gson();
        String OutputJSON = gson.toJson("");
        try {
            HashMap<Integer, animalbridge_homepage> Testing = Model.animalbridge_homepage();
            OutputJSON = gson.toJson(Testing);
        } catch (Exception e) {
            String Error = "RESTful layer GetAllHomepage method has error!!!";
            OutputJSON = gson.toJson(Error);
        }
        return Response.status(200).entity(OutputJSON).build();
    }
